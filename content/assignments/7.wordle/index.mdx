...
3. Demonstrate ability to manipulate the DOM using JavaScript.
...
2. On difficulty selection, we'll make a HTTP Request to [https://it3049c-hangman.fly.dev/](https://it3049c-hangman.fly.dev/) to get a word for the game.
    1. You'll need to specify the difficulty in the query string of your url.
        * [https://it3049c-hangman.fly.dev/?difficulty=easy](https://it3049c-hangman.fly.dev/?difficulty=easy)
        * [https://it3049c-hangman.fly.dev/?difficulty=medium](https://it3049c-hangman.fly.dev/?difficulty=medium)
        * [https://it3049c-hangman.fly.dev/?difficulty=hard](https://hangman-micro-service.herokuapp.com/?difficulty=hard)
