...
| Module |  Date  |                                    Topic                                    |
| ------ | ------ | --------------------------------------------------------------------------- |
| 0      | Before | Course Structure and Development Env Setup                                  |
| 1      | Jan 8  | Source Version Control <br /> How the web works <br /> JS History           |
| 2      | Jan 15 | Fundamentals of JS                                                          |
| 3      | Jan 22 | Interactive Web Dev using JS <br /> Forms, Event handling, DOM Manipulation |
| 4      | Jan 29 | JSON and Networking: Fetch API                                              |
| 5      | Feb 5  | Intro to React <br /> JSX, component-based dev                              |
| 6      | Feb 12 | React State Mgmt & hooks                                                    |
| 7      | Feb 19 | Advanced React: Context API <br /> Web Storage                              |
| 8      | Feb 26 | Canvas API & Animation                                                      |
| 9      | Mar 4  | Effective JS: Organization, linting, tooling                                |
| 10     | Mar 11 | 🏖️ Spring Break                                                             |
| 11     | Mar 18 | SPA: Routing with React Router                                              |
| 12     | Mar 25 | Styling in React: CSS-in-JS, Styled Components                              |
| 13     | Apr 1  | Intro to Phaser                                                             |
| 14     | Apr 8  | More Phaser                                                                 |
| 15     | Apr 15 | Open Lab                                                                    |
